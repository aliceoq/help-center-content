...
9. Em __Campos do provedor__, insira as informações do __MerchantCode__ e __SecretKey__ conforme as informações da sua conta Wepay4u.

10. Em __Currency__, selecione a moeda a ser utilizada na transação de pagamento.

11. Caso seja exibida uma mensagem de alerta indicando a necessidade de instalação do app, clique no botão `Instalar app` e siga as instruções de instalação.
