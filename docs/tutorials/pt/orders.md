...
- [Tabela orders_latest](#tabela-orders-latest)
- [Tabela orders_historical](#tabela-orders-historical)
- [Tabela orders_totals](#tabela-orders-totals)
- [Tabela orders_shipping](#tabela-orders-shipping)
- [Tabela orders_sellers](#tabela-orders-sellers)
- [Tabela orders_rateandbenefitsidentifiers](#tabela-orders-rateandbenefitsidentifiers)
- [Tabela orders_payments](#tabela-orders-payments)
- [Tabela orders_packages](#tabela-orders-packages)
- [Tabela orders_items](#tabela-orders-items)
