...
4. Preencha os seguintes campos com suas informações da Adyen:
    ...
    - **Live URL prefix**: prefixo disponível na customer area da Adyen (passo 2 da seção [Obtenha a Live URL prefix](#obtenha-a-live-url-prefix)).
    ...
    - **Live POS URL**: endpoints utilizados para acessar as APIs de terminais da Adyen. Saiba mais em [documentação Adyen](https://docs.adyen.com/point-of-sale/design-your-integration/terminal-api#cloud). 
