...
- [Tabela payments_transitions](#tabela-payments-transitions)
- [Tabela transaction_trasitions](#tabela-transaction-transitions)
...
| **Histórico** | Os dados são mantidos por dois anos, a partir de 2023 para clientes que já utilizam a plataforma VTEX. |
...
**- Relação com os [SKUs](https://help.vtex.com/tutorial/skus-data-pipeline-beta--4zkfF1asM3ayvIigsySevw):** examinar os dados de pagamento em relação aos produtos comprados ajuda a entender a popularidade de certos produtos e a eficácia das estratégias de preço, impactando na gestão de estoque e na tomada de decisão sobre os produtos.  
