...
4. Rellena los siguientes campos con tus datos de Adyen:
    ...
    - **Live URL prefix**: prefijo disponible en el área de clientes de Adyen (paso 2 de la sección [Obtener la Live URL prefix](#obtener-la-live-url-prefix)).
    ...
    - **Live POS URL**: endpoints utilizados para acceder a las API de terminales de Adyen. Obtenga más información en [documentación de Adyen] (https://docs.adyen.com/point-of-sale/design-your-integration/terminal-api#cloud). 
