...
updatedAt: 2024-02-05T20:29:59.689Z
publishedAt: 2024-02-05T20:29:59.689Z
...
9. En __Campos del proveedor__, ingrese la información __MerchantCode__ y __SecretKey__ según la información de su cuenta Wepay4u.

10. En __Currency__, seleccione la moneda que se utilizará en la transacción de pago.

11. Si aparece un mensaje de alerta que indica la necesidad de instalar la aplicación, haga clic en el botón `Instalar aplicación` y siga las instrucciones de instalación.
