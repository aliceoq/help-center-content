...
updatedAt: 2024-02-06T11:40:45.294Z
publishedAt: 2024-02-06T11:40:45.294Z
...
9. En __Campos del Proveedor__, ingrese la información __TradeID__, __TradeName__, __TradeEmail__ y __MaxActiveCipTime__ según la información de su cuenta PagoEfectivoV2.

10. En __Country__, seleccione el país donde se realizará la transacción de pago.

11. En __Currency__, seleccione la moneda que se utilizará en la transacción de pago.

12. Si aparece un mensaje de alerta que indica la necesidad de instalar la aplicación, haga clic en el botón `Instalar aplicación` y siga las instrucciones de instalación.
