...
9. In __Provider Fields__, enter the __MerchantCode__ and __SecretKey__ information as per your Wepay4u account information.

10. In __Currency__, select the currency to be used in the payment transaction.

11. If an alert message appears indicating the need to install the app, click on the `Install app` button and follow the installation instructions.
