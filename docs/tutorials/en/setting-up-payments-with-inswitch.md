...
At VTEX, it is possible to integrate with the Inswitch payment provider. With this connector, your store can make sales through the Inswitch.

To configure Inswitch affiliation, follow the steps below:
...
3. Click on the __Inswitch__ connector.
...
After following the indicated steps, Inswitch connector may take up to 10 minutes to appear at your store's checkout as a payment option.
