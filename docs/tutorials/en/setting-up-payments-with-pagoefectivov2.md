...
9. In __Provider Fields__, enter the __TradeID__, __TradeName__, __TradeEmail__ and __MaxActiveCipTime__ information according to your PagoEfectivoV2 account information.

10. In __Country__, select the country where the payment transaction will be carried out.

11. In __Currency__, select the currency to be used in the payment transaction.

12. If an alert message appears indicating the need to install the app, click on the `Install app` button and follow the installation instructions.
