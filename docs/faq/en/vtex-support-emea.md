...
Our regular support hours are Monday through Friday, from 7am CET to 5pm CET. Support for urgent requests is available 24/7. Our average first response time varies according to ticket urgency, as seen in the table below.

| **Ticket urgency** | **Average first response time** | **Average next response time** | 
| -----|----- |----- |
| **Low**   |2 hours  | 8 hours |
| **Normal** |2 hours | 8 hours |
| **High** | 2 hours | 8 hours|
| **Urgent**| 1 hour | 2 hours|
