...
updatedAt: 2024-02-22T14:07:27.548Z
publishedAt: 2024-02-22T14:07:27.548Z
...
2. **Solicitar apuntamiento interno:** hay que abrir un ticket con el [soporte VTEX](https://help.vtex.com/es/tracks/soporte-en-vtex--4AXsGdGHqExp9ZkiNq9eMy) para solicitar el apuntamiento de DNS interno. El plazo para completar esta solicitud es de hasta tres días laborables.
  ...
  <tbody>
    <tr>
      <td>Store Framework o FastStore (VTEX IO)</td>
      <td>Solicitar el <a href="https://help.vtex.com/es/tracks/realizando-o-go-live-da-sua-loja--4Ns5FxIiksmjsdX2yOTduM/7sM5IMx02zaHvAFTm0OxiJ#solicitar-apontamento-io" target="_blank" rel="noopener noreferrer">apuntamiento de DNS interno para VTEX IO</a> mediante un ticket con el <a href="https://help.vtex.com/es/support" target="_blank" rel="noopener noreferrer">soporte VTEX</a>.<br> <br>Para más información, consulta los artículos:<ul><li><a href="https://developers.vtex.com/docs/guides/vtex-io-documentation-go-live" target="_blank" rel="noopener noreferrer">Going live with a new store</a> (Store Framework)</li><li><a href="https://developers.vtex.com/docs/guides/vtex-io-documentation-migrating-storefront-from-legacy-to-io" target="_blank" rel="noopener noreferrer">Migrating your storefront from Legacy CMS Portal to Store Framework</a></li><li><a href="https://www.faststore.dev/docs/go-live/2-configuring-external-dns" target="_blank" rel="noopener noreferrer">Configuring external DNS for a custom domain</a> (FastStore)</li></ul></td>
    </tr>
    <tr>
      <td>CMS Portal Legado</td>
      <td>Si el acceso a la tienda está restringido por una <a href="https://help.vtex.com/es/tutorial/o-que-e-uma-politica-comercial--563tbcL0TYKEKeOY4IAgAE">política comercial</a> con una regla condicional y tu storefront fue creado con<a href="https://help.vtex.com/es/tracks/cms--2YcpgIljVaLVQYMzxQbc3z/1oN446gRGcR2s70RvBCAmj">CMS Portal Legado</a>, debes solicitar un <a href="https://help.vtex.com/es/tracks/go-live-your-store--4Ns5FxIiksmjsdX2yOTduM/7sM5IMx02zaHvAFTm0OxiJ#solicitar-apontamento-especial">apuntamiento interno especial</a>. Un ejemplo común son las tiendas B2B que restringen el acceso a empresas preaprobadas. La solicitud de apuntamiento especial se envía a través del<a href="http://link-trilha-suporte-vtex-suporte-comercial/"> </a><a href="http://link-trilha-suporte-vtex-suporte-comercial/">soporte VTEX</a>, que debe incluir la política comercial y la regla condicional configurada.</td>
    </tr>
  </tbody>
  </table>
...
- [Rendimiento de las páginas web:](https://help.vtex.com/es/tutorial/rendimiento-de-paginas-web--4cRiiTByzNMulixZec5YaG) herramienta _PageSpeed Insights_ de Google en el Admin VTEX para monitorear el rendimiento de las URL de la tienda online utilizando simulaciones con [Lighthouse](https://developer.chrome.com/docs/lighthouse/overview/).
