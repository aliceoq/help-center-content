...
6. Para [autorizar a integradora](https://marketplace-faq.magazineluiza.com.br/faq/como-autorizar-minha-integradora-a-operar-a-minha-loja-no-magalu) VTEX, no portal do Magalu Marketplace, acesse **MENU > Integradoras.**
7. Na barra de busca, digite `VTEX` e clique no botão `Autorizar`.
8. No modal que aparecerá, selecione as seguintes opções de [consentimento de integração](https://marketplace-faq.magazineluiza.com.br/faq/como-consentir-com-a-integracao):
