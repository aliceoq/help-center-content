...
2. **Solicitar apontamento interno:** abrir um ticket para o [Suporte VTEX](https://help.vtex.com/tracks/suporte-na-vtex--4AXsGdGHqExp9ZkiNq9eMy) para solicitar o apontamento interno de DNS. O tempo para a conclusão desta solicitação pode ser de até três dias úteis.
  ...
  <tbody>
    <tr>
      <td>Store Framework ou FastStore (VTEX IO)</td>
      <td>Solicitar o <a href="https://help.vtex.com/pt/tracks/realizando-o-go-live-da-sua-loja--4Ns5FxIiksmjsdX2yOTduM/7sM5IMx02zaHvAFTm0OxiJ#solicitar-apontamento-io" target="_blank" rel="noopener noreferrer">apontamento interno de DNS para VTEX IO</a> por meio de um ticket para o <a href="https://help.vtex.com/pt/support" target="_blank" rel="noopener noreferrer">Suporte VTEX</a>.<br>Mais informações nos artigos:<ul><li><a href="https://developers.vtex.com/docs/guides/vtex-io-documentation-go-live" target="_blank" rel="noopener noreferrer">Going live with a new store</a>(Store Framework)</li><li><a href="https://developers.vtex.com/docs/guides/vtex-io-documentation-migrating-storefront-from-legacy-to-io" target="_blank" rel="noopener noreferrer">Migrating your storefront from Legacy CMS Portal to Store Framework</a></li><li><a href="https://www.faststore.dev/docs/go-live/2-configuring-external-dns" target="_blank" rel="noopener noreferrer">Configuring external DNS for a custom domain</a> (FastStore)</li></ul></td>
    </tr>
    <tr>
      <td>CMS Portal Legado</td>
      <td>Se o acesso à loja é restrito por <a href="https://help.vtex.com/pt/tutorial/o-que-e-uma-politica-comercial--563tbcL0TYKEKeOY4IAgAE">política comercial</a> com regra condicional e sua frente de loja foi construída com <a href="https://help.vtex.com/pt/tracks/cms--2YcpgIljVaLVQYMzxQbc3z/1oN446gRGcR2s70RvBCAmj">CMS Portal Legado</a>, é preciso solicitar um <a href="https://help.vtex.com/pt/tracks/go-live-your-store--4Ns5FxIiksmjsdX2yOTduM/7sM5IMx02zaHvAFTm0OxiJ#solicitar-apontamento-especial">apontamento interno especial</a>. Um exemplo comum são as lojas B2B, que restringem o acesso a empresas pré-aprovadas. A solicitação de apontamento especial é feita pelo <a href="https://help.vtex.com/tracks/suporte-na-vtex--4AXsGdGHqExp9ZkiNq9eMy/3KQWGgkPOwbFTPfBxL7YwZ/">Suporte VTEX</a>, indicando a política comercial e a regra condicional configurada.</td>
    </tr>
  </tbody>
  </table>
...
- [Performance de páginas Web](https://help.vtex.com/pt/tutorial/web-page-performance--4cRiiTByzNMulixZec5YaG): ferramenta _PageSpeed Insights_ do Google no Admin VTEX, para monitorar o desempenho das URLs do ecommerce a partir de simulações com o [Lighthouse](https://developer.chrome.com/docs/lighthouse/overview/).
